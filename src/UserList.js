...
import { addUserTop, addUserBottom } from "./actionCreators";
...
class UserList extends React.Component {
  ...
  onAddUser = (user, direction = "bottom") => {
    direction === "top"
      ? this.props.dispatch(addUserTop(user))
      : this.props.dispatch(addUserBottom(user))
  };
...
const mapDispatchToProps = (dispatch) => ({
  removeUser : (id) => dispatch({ type: "user_list/remove_user", payload: id }),
  selectUser: (id) => dispatch({ type: "user_list/selected_user", payload: id }),
  dispatch,
});
